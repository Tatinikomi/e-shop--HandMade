...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "INSERT INTO  rabota (id_cat,`name`,opisanie,`image`,img_2,img_3,`stoimost`) value('$id_cat','$name','$opisanie','$image','$img_2','$img_3','$stoimost')");
    if ($query) {
...
<label for="exampleInputEmail1">Стоимость</label> <input type="text" class="form-control" name="stoimost" id="stoimost" value="<?php  echo $row['stoimost'];?>" required="true"> 
