...
<h5 align="center" style="color:blue"> <?php echo $fdate?> <?php echo $tdate?></h5>
      ...
      $id_mk = $_GET['del'];
      $query = "DELETE FROM  mk WHERE id_mk = $id_mk ";
      mysqli_query($con,$query) or die (mysqli_error($con));
  } ?>
<?php
$ret=mysqli_query($con,"SELECT * FROM mk");
$cnt=1;
...
<!--Выводим список из бд-->
						 <tr> 
					  	...
					  	<td> <a href="mk_detail.php?id_mk=<? echo $row['id_mk'];?>">Ред.</a></td> 
							<td> <a href="?del=<? echo $row['id_mk'];?>">Удал.</a></td> 
						  </tr>   
              <?php $cnt=$cnt+1;}?>
              </tbody>
              </table> 
