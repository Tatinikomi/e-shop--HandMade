...
?>
						 ...
						 <tr> 
						 	...
						 	<td><?php  echo $row['cat_produkt'];?></td> 
							<td><?php  echo $row['opisanie'];?></td>
						 	...
						 	<td> <?php  echo $row['stoimost_zakypki'];?></td>
						 	<td> <?php  echo $row['na_sklade'];?></td> 
							 <td><?php  echo $row['kol_vo'];?></td>
						 	<td><?php  echo $row['price'];?></td>
						 		<td> <a href="product.php?id=<? echo $row['id'];?>">Ред.</a></td> 
                            	<td> <a href="?del=<? echo $row['id'];?>">Удал.</a></td> 
						  </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
