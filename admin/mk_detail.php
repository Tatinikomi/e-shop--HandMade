...
if(isset($_POST['submit']))
  {
    ...
    $id_cat=$_POST['id_cat'];	
		...
		$query=mysqli_query($con,"UPDATE mk set title='$title',title_2='$title_2',post='$post',`image`='$image', img_2='$img_2',img_3='$img_3',`date`='$date',id_cat='$id_cat',id_admin='$id_admin' WHERE  id_mk='$id_mk'");
    if ($query) {
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
								...
								<?php
							$ret=mysqli_query($con,"select * from  mk WHERE id_mk='$id_mk'");
							$cnt=1;
