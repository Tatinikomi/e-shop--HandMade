...
if(isset($_POST['submit']))
  {
    ...
    $id_cat=$_POST['id_cat'];	
		...
		$query=mysqli_query($con,"UPDATE posts set title='$title',title_2='$title_2',post='$post',`image`='$image', img_2='$img_2',img_3='$img_3',`date`='$date',id_cat='$id_cat',id_admin='$id_admin' WHERE  id_post='$id_post'");
    if ($query) {
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
								...
								<?php
							$ret=mysqli_query($con,"select * from  posts WHERE id_post='$id_post'");
							$cnt=1;
                ...
                <div class="form-group"> 
							 ...
							 <div class="form-group"> 			 <label for="exampleInputEmail1">Дата</label> <input type="text" class="form-control" name="date" id="date" value="<?php  echo $row['date'];?>" required="true">

				
							 <label for="exampleInputEmail1">Категория</label> <input type="text" class="form-control" name="id_cat" id="id_cat" value="<?php  echo $row['id_cat'];?>" required="true">

               <label for="exampleInputEmail1">Админ</label> <input type="text" class="form-control" name="id_admin" id="id_admin" value="<?php  echo $row['id_admin'];?>" required="true"> </div>
