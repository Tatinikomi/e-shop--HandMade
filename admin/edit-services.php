	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Обновить услугу</h3>
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Наименование услуги</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Наименование услуги" value="<?php  echo $row['ServiceName'];?>" required="true"> </div> <div class="form-group"> <label for="exampleInputPassword1">Цена</label> <input type="text" id="cost" name="cost" class="form-control" placeholder="Цена" value="<?php  echo $row['Cost'];?>" required="true"> </div>
							 <?php } ?>
