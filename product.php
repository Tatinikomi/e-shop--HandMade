...
<!--/Меню-->
    ...
    <h6 class="pro-price">Цена: <span class="item_price"><?php echo $tovar['price'];?></span>руб</h6>
                 ...
                 <ul class="action-button">  
                     <li>
										 <button id='product'  class="add_item" data-id="<? echo $tovar['id'];?>" data-title="<?php echo $tovar['name'];?>"data-price="<?php echo $tovar['price'];?>" data-img="<? echo $tovar['image'];?>" data-count="100500">В корзину</button>
                     </li>
                 </ul>
